...
_AboutUsPage.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵdefineComponent"]({
  ...
  decls: 3,
  vars: 2,
  consts: [["showOldTheme", ""], [4, "ngIf", "ngIfElse"], [1, "background-cl", 3, "ngStyle"], ["title", "About us", "subtitle", "", "showsubTxt", "true", "showsubtitle", "false"], ["class", "background-cl", "padding", "", 4, "ngIf"], ["class", "center", 4, "ngIf"], ["padding", "", 1, "background-cl"], [1, "mt20", "p5", "context", 3, "innerHTML"], [1, "center"], ["mode", "md", 1, "background-cl"], ["slot", "start"], [2, "color", "var(--viewBgColor)", "font-weight", "bold", 3, "click"], [2, "color", "var(--viewBgColor)", "font-weight", "bold"], ["padding", ""], ["class", "mt20 p5 context", 3, "innerHTML", 4, "ngIf"]],
